...
{
    /// <summary>
    /// Класс, отвечающий за фигуру Z
    /// * *
    ///   * *
    /// </summary>
    class Light : FigureTetris
    {
        /// <summary>
        ...
        /// <summary>
        /// Конструктор Класса Light, для создания списка фигур из 4 точек
        /// </summary>
        public Light()
        {
        ...
        /// <summary>
        /// Создать Фигуру Light, путем установки начальных точек фигуры, относительно центральной части
        /// </summary>

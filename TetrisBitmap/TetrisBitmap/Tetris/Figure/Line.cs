...
{
    /// <summary>
    /// Класс, отвечающий за фигуру линия
    /// * * * *
    /// </summary>
    class Line : FigureTetris
    {
        /// <summary>
        ...
        /// <summary>
        /// Конструктор Класса Line, для создания списка фигур из 4 точек
        /// </summary>
        public Line()
        {
        ...
        /// <summary>
        /// Создать Фигуру Line, путем установки начальных точек фигуры, относительно центральной части
        /// </summary>
        ...
        public override void PointDefault()
        {
            ...
            figure[2] = new Point(1, 0);
            figure[3] = new Point(2, 0);
        }
    }
}

...
{
    /// <summary>
    /// Класс, отвечающий за фигуру Г
    /// * *
    /// *
    /// *
    /// </summary>
    class G : FigureTetris
    {
        /// <summary>
        ...
        /// <summary>
        /// Конструктор Класса G, для создания списка фигур из 4 точек
        /// </summary>
        public G()
        {
        ...
        /// <summary>
        /// Создать Фигуру G, путем установки начальных точек фигуры, относительно центральной части
        /// </summary>
